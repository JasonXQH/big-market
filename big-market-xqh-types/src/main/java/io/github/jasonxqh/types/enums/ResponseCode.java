package io.github.jasonxqh.types.enums;
...
public enum ResponseCode {
    ...
    ACTIVITY_RAFFLE_ORDER_ERROR("ERR_BIZ_009", "用户抽奖单已使用过，不可重复抽奖"),
    USER_CREDIT_ACCOUNT_NO_AVAILABLE_AMOUNT("ERR_BIZ_010", "用户积分不足，无法消费");
